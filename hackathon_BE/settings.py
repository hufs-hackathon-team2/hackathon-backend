"""
Django settings for hackathon_BE project.
...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', '3.34.161.144', 'meotjinsaja.shop']
...
ROOT_URLCONF = 'hackathon_BE.urls'
...
WSGI_APPLICATION = 'hackathon_BE.wsgi.application'
